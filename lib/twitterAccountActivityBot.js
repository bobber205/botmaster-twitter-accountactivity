      ...
      join(quiz_def, extra_lives_def, iq_score_def, user_bot_status_def, has_used_extra_life_for_quiz_def, has_extra_life_waiting_to_be_awarded_def, (whole_question_object, extra_life_redis_value, score, bot_state_status, has_used_extra_life_for_quiz, has_extra_life_waiting_to_be_awarded_value) => {
        ...
        if (whole_question_object) {
          ...
          if (answered_on_time || answered_late_but_its_ok) {
           ...
           if (message_text_urls_removed.toUpperCase() == 'FAQ' || message_text_urls_removed.toUpperCase() == 'SHOW ME SOME FAQS') {
           ...
           } else if (message_text_urls_removed.toUpperCase() === 'GET AN EXTRA LIFE OLD' || message_text_urls_removed.toUpperCase() === 'EXTRA OLD' || message_text_urls_removed.toUpperCase() === 'EXTRA LIFE OLD') {
             ...
             var code_link = `https://twitter.com/intent/tweet?url=https%3A%2F%2Fpic.twitter.com/ko6BlvPiCb&text=Come%20play%20%40IQtrivia%20with%20me%21%20Use%20my%20code%20%27${redemption_code}%27%20and%20you%27ll%20get%20an%20extra%20life%3A%20https%3A%2F%2Ftwitter.com%2Fmessages%2Fcompose%3Frecipient_id%3D136023366%26text%3DRedeem%2520an%2520invite%2520for%2520an%2520extra%2520life%20%23Trivia%20%23IQtrivia`
             this.__sendDMToUser(sender_id, receiver_object.screen_name, `To get an extra life just tell your friends to come play and enter your code: '${redemption_code.toUpperCase()}'. When a friend redeems your invite, and answers their first question, you'll get an extra life. Your friend will also get an extra life too! You can get as many extra lives as you want, and you can use one per game. You currently have ${extra_life_redis_value} extra lives.\n\nShare your code to get extra lives: ${code_link}`, false, '', true);
