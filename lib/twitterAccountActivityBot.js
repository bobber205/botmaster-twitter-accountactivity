        ...
        if (whole_question_object) {
          ...
          if (answered_on_time || answered_late_but_its_ok) {
           ...
           if (message_text_urls_removed.toUpperCase() == 'FAQ' || message_text_urls_removed.toUpperCase() == 'SHOW ME SOME FAQS') {
             ...
             this.__sendDMToUser(sender_id, receiver_object.screen_name, `To get an extra life just tell your friends to come play and enter your code: '${redemption_code}'. When a friend redeems your invite, and answers their first question, you'll get an extra life. Your friend will also get an extra life too! You can get as many extra lives as you want, and you can use one per game.\n\nShare your code to get extra lives: ${code_link}`, false, '', false);
