...
class TwitterAccountActivityBot {
  ...
  __processDirectMessageEvent(messages)  {
    ...
    _.each(events, (direct_message_entry) => {
      ...
      console.log(`has_used_extra_life_for_quiz_def`, redisHelpers.currentExtraLivesUsedKey(`${receiver_object.screen_name.toLowerCase()}`), `${sender_object.screen_name.toLowerCase()}`);
