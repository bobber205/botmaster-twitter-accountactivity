      ...
      join(quiz_def, extra_lives_def, iq_score_def, (whole_question_object, hash_values, score) => {
        ...
        if (whole_question_object) {
          ...
          if (answered_on_time || answered_late_but_its_ok) {
           ...
           if (message_text_urls_removed.toUpperCase() == 'FAQ') {
           ...
           } else if (message_text_urls_removed.toUpperCase() == 'IQ SCORE' || message_text_urls_removed.toUpperCase() == 'IQ' || message_text_urls_removed.toUpperCase() == 'IQ SCORE &AMP; GAME STATS') {
           ...
           } else if (message_text_urls_removed.toUpperCase() == 'FEEDBACK?') {
             this.__sendDMToUser(sender_id, receiver_object.screen_name, `Did you have an issue playing the game? We wanna know!\n\nTalk to us directly by emailing feedback@iqtrivia.live <a href="mailto:feedback@iqtrivia.live">or click here!</a>`, false);
           
           } else if (message_text_urls_removed.toUpperCase() === '#PROTIPS' || message_text_urls_removed.toUpperCase() === 'PROTIPS') {
             ...
             this.__sendDMToUser(sender_id, receiver_object.screen_name, `To get an extra life all you need to do is share the game by tapping here ${link}`, false, '', true);
           }
