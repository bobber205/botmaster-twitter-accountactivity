...
class TwitterAccountActivityBot {
  ...
  __parseUserNumber(sender_object, receiver_object, phone_number_submitted) {
    ...
    var is_valid = phoneUtil.isValidNumber(phone_number_submitted);

    var message = is_valid ? 'That phone number is good to go!' : 'bad number receive!';
    this.__sendDMToUser(sender_id, receiver_object.screen_name, `${message}`, false, '', true);
  }
