...
class TwitterAccountActivityBot {
  ...
  __processUserRequestedLifeSaverLink(sender_object, receiver_object) {
    const hash_parameter = cipherHelpers.createCipherHash(sender_object.screen_name, sender_object.id, 10);
    ...
    const dm_text = `Glad you want to save your life!\n\nJust go here to purchase or update your payment info ☝️ ${link}`;
