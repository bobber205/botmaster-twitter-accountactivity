        ...
        if (whole_question_object) {
          ...
          if (question_matched) {
            ...
            if (reply_answer_status_to_user) {
              ...
              var responded_status_key_by_answer_value = redisClient.hgetAsync(redisHelpers.getRespondedAnswerKey(receiver_object.screen_name, message_value_type), sender_object.screen_name);
              join(responded_status_key, responded_status_key_by_answer_value).then((already_responded_value, status_value) => {
                ...
                if (already_responded_value != "1" && is_valid_answer) {
                  ...
                  redisClient.hset(redisHelpers.getRespondedAnswerKey(receiver_object.screen_name, message_value_type), sender_object.screen_name, "1", redis.print);
