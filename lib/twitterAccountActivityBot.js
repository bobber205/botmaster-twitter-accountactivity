    ...
    redisClient.hgetAsync(redisHelpers.getIQStatsKey(), sender_handle).then((result) => {
      if (!result) {
        ...
        if (percentile == 0) {
          ...
          var dynamic_intent = `https://twitter.com/intent/tweet?url=https%3A%2F%2Fpic.twitter.com/hUKXWZjFxs&text=My%20%40IQtrivia%20IQ%20score%20is%20${percentile}.\n%20I%27ve%20played%20${quizzes_count}%20games%2C%20and%20got%20${right_count}%20questions%20right%2C%20and%20${wrong_count}%20wrong.%20I%27m%20in%20${rank}%20place%21`;
