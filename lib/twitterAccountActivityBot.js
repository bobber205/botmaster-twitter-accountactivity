...
class TwitterAccountActivityBot {
  ...
  __processUserHasOptedInEvent(sender_object, receiver_object) {
    console.log(`${sender_object.screen_name} (${sender_object.id_str}) has opted in!`);
    redisClient.hset(redisHelpers.getPlayerListKey(receiver_object.screen_name), sender_object.id_str.toLowerCase(), '1');
  }
