          ...
          if ( (answered_on_time || answered_late_but_its_ok) && question_matched) {
            ...
            if (direct_message_entry.answer_value) {
              if (direct_message_entry.extra_life_used) {
                redisClient.set(redisHelpers.getLatestAnswerValueKey(sender_object.id), `${direct_message_entry.answer_value}_extralifeused`, direct_message_entry.question_number);
              } else {
                redisClient.set(redisHelpers.getLatestAnswerValueKey(sender_object.id), direct_message_entry.answer_value, direct_message_entry.question_number);
              }
