...
module.exports.getAppropriateMediaResponse = (master_config_object, status) => {
  var media_id_array = [];
  if (status == 'correct') media_id_array = master_config_object.right_answer_responses;
  if (status == 'wrong') media_id_array = master_config_object.wrong_answer_responses;
  if (status == 'late') media_id_array = master_config_object.late_answer_responses || master_config_object.wrong_answer_responses;
