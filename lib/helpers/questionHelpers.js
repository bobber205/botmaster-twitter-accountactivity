...
const got_your_answer_list = compact(readlines.readlinesSync("config/got_your_answer_list.txt"));
const you_are_late_answer_list = compact(readlines.readlinesSync("config/you_are_late_answer_list.txt"));
...
module.exports.getYourAreLateResponse = () => {
  return chain(you_are_late_answer_list).sample().value();
};

module.exports.getWeGotItResponse = () => {
  return chain(got_your_answer_list).sample().value();
};
