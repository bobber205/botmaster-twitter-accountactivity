...
module.exports.getLatestAnswerValueKey = (handle, question_number = 'state') => {
  return `Chirpify::IQTrivia::LatestUserAnswerValue::${handle.toLowerCase()}::QuestionNumber::${question_number}`;
};
