        ...
        if (master_question_object) {
          ...
          if (question_matched) {
            ...
            if (reply_answer_status_to_user) {
              let message_to_user = was_correct == "1" ? `Your Answer for Question ${question_matched.question_number + 1} Was Correct! :D ${moment().format("x")}` : `Your Answer For ${question_matched.question_number + 1} was wrong! ${moment().format("x")}`;
