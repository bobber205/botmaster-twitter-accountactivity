...
class TwitterAccountActivityBot extends BaseBot {
  ...
  __processTypingEvent(messages) {
    ...
    _.each(events, (event) => {
      ...
      var sender_id = event.target.sender_id;
      ...
      redisClient.get(redis_key, (err, master_question_object) => {
        ...
        let dm_payload = {
          event: {
            ...
            message_create: {
              ...
              message_data: {
                text: question_matched.raw_question
              }
            }
          }
        };
        ...
        this.twitterClient.post('direct_messages/events/new', dm_payload, (response) => {console.log(response)});
      });
    });
  }
