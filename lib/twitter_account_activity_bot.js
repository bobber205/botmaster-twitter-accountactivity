...
const sidekiqConnection = new Sidekiq(redisClient, process.env.NODE_ENV);
  ...
  __createMountPoints(expressApp) {
    ...
    this.app.get('*', (req, res) => {
      ...
      if (req.query.crc_token) {
        ...
        if (req.body) {
          sidekiqConnection.enqueue('Chirpify::Workers::GenericLoggerWorker', ['debug_log', JSON.stringify(req.body)] );
        }
